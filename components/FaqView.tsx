    ...
    en: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "OpenAI does not always publish an exact reset time. This site shows official notices and estimates whether a usage-limits reset looks likely within the next 12, 24, 48, or 72 hours.",
        },
        {
