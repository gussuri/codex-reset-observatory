  ...
  const content = {
    ja: {
      ...
      paragraphs: [
        ...
        "任意リセット（マニュアルリセット）や友達紹介リセットを使用した場合、次回定期リセット日がこちらに表示している日付とずれます。任意リセット枠には1か月以内の期限があります。",
      ],
      nav: {
        top: "トップへ戻る",
        faq: "FAQを見る",
    ...
    en: {
      ...
      subTitle: "An unofficial reference site for Codex reset history, weekly reset references, manual reset credits, and random reset signals.",
      paragraphs: [
        ...
        "The random reset probability is a reference estimate based on public signals, usage-limit anomalies, community activity, and official updates. It is not an official OpenAI notice.",
