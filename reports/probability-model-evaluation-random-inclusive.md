...
| --- | ---: | --- | ---: | ---: |
| hazard-odds-v3-random-inclusive | none | baseline | 0.2558 | 0.2991 |
...
| hazard-odds-v3-recency-bayes-h30-r2 | 30 | no_meaningful_difference | 0.2536 | 0.2964 |
...
- Difference vs current Brier: 24h +0.0051, 48h +0.0058
- 24h block bootstrap 95% CI: [-0.0060, 0.0246]
- 48h block bootstrap 95% CI: [-0.0029, 0.0171]
- Non-overlapping 48h: n=21, actual=57.14%, mean=30.75%, Brier=0.2998, logLoss=0.8011
- Non-overlapping 48h difference vs v2: Brier +0.0100, logLoss +0.0228
...
- Difference vs current Brier: 24h -0.0150, 48h -0.0315
- 24h block bootstrap 95% CI: [-0.0490, 0.0094]
- 48h block bootstrap 95% CI: [-0.0753, 0.0074]
- Non-overlapping 48h: n=21, actual=57.14%, mean=42.00%, Brier=0.2528, logLoss=0.7015
- Non-overlapping 48h difference vs v2: Brier -0.0370, logLoss -0.0768
...
- Difference vs current Brier: 24h -0.0017, 48h -0.0013
- 24h block bootstrap 95% CI: [-0.0059, 0.0030]
- 48h block bootstrap 95% CI: [-0.0178, 0.0187]
- Non-overlapping 48h: n=21, actual=57.14%, mean=32.16%, Brier=0.2902, logLoss=0.7840
- Non-overlapping 48h difference vs v2: Brier +0.0004, logLoss +0.0057
...
- 24h block bootstrap 95% CI: [-0.0055, 0.0016]
- 48h block bootstrap 95% CI: [-0.0125, 0.0088]
- Non-overlapping 48h: n=21, actual=57.14%, mean=32.84%, Brier=0.2875, logLoss=0.7753
- Non-overlapping 48h difference vs v2: Brier -0.0023, logLoss -0.0031
...
- Difference vs current Brier: 24h -0.0014, 48h -0.0019
- 24h block bootstrap 95% CI: [-0.0037, 0.0009]
- 48h block bootstrap 95% CI: [-0.0074, 0.0046]
- Non-overlapping 48h: n=21, actual=57.14%, mean=33.00%, Brier=0.2880, logLoss=0.7753
- Non-overlapping 48h difference vs v2: Brier -0.0018, logLoss -0.0031
