...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "公式予告がある場合は、その内容を優先して確認します。予告がない場合は、直近の履歴やStatusの動きから現在の見立てを表示しています。",
  },
  {
    question: "トークン・使用量・制限・レートのリセットは同じ意味ですか？",
    answer:
      "検索では似た意味で使われることがあります。このサイトでは、Codexの利用上限や使用量の回復につながるリセットを中心に扱っています。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "コンテキスト圧縮や長いセッションの不具合が、利用上限の補償リセットにつながる場合があります。単なる会話や作業状態のリセットとは分けて見ています。",
  },
  {
    question: "Codex CLIのリセットも確認できますか？",
    answer:
      "Codex全体の利用上限やStatusに関係する動きは参考になります。一方で、CLIの設定初期化やローカル環境のリセットはこのサイトの対象外です。",
  },
  {
    question: "このサイトの情報はどこから取得していますか？",
    answer:
      "過去のリセット履歴、公式発表、OpenAI Status、コミュニティ上の公開情報などを参考にしています。",
  },
  {
