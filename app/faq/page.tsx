...
const faqs = [
  {
    ...
    answer:
      "Codexの公式リセット予告、定期リセット、履歴、期待度を見ています。確認済みの履歴や定期リセット情報はこのサイト側にも保存し、外部サイトの情報は判断材料のひとつとして参照します。",
  },
  {
    question: "リセットとは何ですか？",
    answer:
  ...
  },
  {
    ...
    answer:
      "公式予告は、OpenAIや関係者による発表など、リセット実施を示すかなり強い手がかりです。定期リセットは、Codexに表示された情報やこのサイト側で把握した実績をもとに更新します。",
  },
  {
