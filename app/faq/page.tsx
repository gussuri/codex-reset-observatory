...
const faqs = [
  {
    ...
    answer:
      "Codexの通常の週次リセットではなく、障害対応、補償、到達記念、臨時対応などによるランダムリセットの予告・履歴・期待度を観測しています。",
  },
  {
    question: "定期リセットとランダムリセットの違いは？",
    answer:
      "定期リセットは通常の利用枠更新として予定どおり発生するものです。ランダムリセットは、障害対応や記念イベントなどをきっかけに、通常スケジュールとは別に発生する臨時のリセットを指します。",
  },
  {
