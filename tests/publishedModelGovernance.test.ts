...
test("published model governance config records Survival v1 and historical boundaries", () => {
  ...
  assert.equal(PUBLISHED_SURVIVAL_CONDITIONED_ADOPTION_DATE, "2026-09-19");
