...
test("hides stale schedule timestamps when an official notice resolution is unresolved", () => {
  const calculationNow = new Date("2026-08-02T00:00:00.000Z");
  const openedAt = "2026-08-01T23:45:00.000Z";
  const data = getLocalRadarData({
    calculationNow,
    activeTiboSignals: [{
      tweet_id: "presentation-stale-unresolved-notice",
      signal_type: "official_notice",
      text: "A reset notice without a trusted schedule",
      tweet_url: "https://x.com/thsottiaux/status/presentation-stale-unresolved-notice",
      tweet_created_at: openedAt,
