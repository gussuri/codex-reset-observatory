...
export const DYNAMIC_TRANSLATIONS: Record<string, Record<Locale, string>> = {
  ...
  "OpenAIがGPT-5.6（Sol/Terra/Luna）の太平洋時間7月9日12:00（日本時間7月10日4:00）リリースを発表。リリース記念としてCodex利用制限の全体リセットが実施される可能性があります。": {
    ja: "OpenAIがGPT-5.6（Sol/Terra/Luna）の太平洋時間7月9日12:00（日本時間7月10日4:00）リリースを発表。リリース記念としてCodex利用制限の全体リセットが実施される可能性があります。",
    en: "OpenAI announced the release of GPT-5.6 (Sol/Terra/Luna) on July 9 at 12:00 PM PT (July 10 at 4:00 AM JST). A global Codex usage limit reset may be executed to celebrate the release.",
    zh: "OpenAI宣布将于太平洋时间7月9日12:00（北京时间7月10日03:00）发布GPT-5.6（Sol/Terra/Luna）。可能会执行全员Codex使用限制重置以示庆祝。",
  },
  "OpenAI公式Xで告知あり": {
    ja: "OpenAI公式Xで告知あり",
