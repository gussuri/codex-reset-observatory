...
export const UI_TRANSLATIONS: Record<string, Record<Locale, string>> = {
  ...
  outlookWeakTeaser: {
    ...
    en: "A post hints at a reset, making a reset slightly more likely.",
    zh: "有帖子暗示可能重置，重置的可能性略有上升。",
  },
  outlookUsageAnomaly: {
  ...
  outlookLowUnder24h: {
    ja: "前回のリセットからまだ時間がたっていません。最近のランダムリセットのペースは、これまでより遅めです。",
    en: "Not much time has passed since the last reset. Recent random resets have been occurring at a slower pace than before.",
    zh: "距离上次重置还没过多久。最近的随机重置节奏比过去更慢。",
  },
  outlookLow24To72h: {
    ja: "前回のリセットから少し時間がたっています。最近のランダムリセットのペースは、これまでより遅めです。",
    en: "Some time has passed since the last reset. Recent random resets have been occurring at a slower pace than before.",
    zh: "距离上次重置已经过了一段时间。最近的随机重置节奏比过去更慢。",
  },
  outlookLow72hPlus: {
    ja: "前回のリセットから時間がたっています。最近のランダムリセットのペースは、これまでより遅めです。",
    en: "More time has passed since the last reset. Recent random resets have been occurring at a slower pace than before.",
    zh: "距离上次重置已经过了较长时间。最近的随机重置节奏比过去更慢。",
  },
  outlookNormalUnder24h: {
    ja: "前回のリセットからまだ時間がたっていません。",
    en: "Not much time has passed since the last reset.",
    zh: "距离上次重置还没过多久。",
  },
  outlookNormal24To72h: {
    ja: "前回のリセットから少し時間がたっています。",
    en: "Some time has passed since the last reset.",
    zh: "距离上次重置已经过了一段时间。",
  },
  outlookNormal72hPlus: {
    ja: "前回のリセットから時間がたっています。",
    en: "More time has passed since the last reset.",
    zh: "距离上次重置已经过了较长时间。",
  },
  outlookHighUnder24h: {
    ja: "最近のランダムリセットのペースは、これまでより速めです。ただし、前回のリセットからはまだ時間がたっていません。",
    en: "Recent random resets have been occurring at a faster pace than before. However, not much time has passed since the last reset.",
    zh: "最近的随机重置节奏比过去更快。不过，距离上次重置还没过多久。",
  },
  outlookHigh24To72h: {
    ja: "最近のランダムリセットのペースは、これまでより速めです。前回のリセットからも少し時間がたっています。",
    en: "Recent random resets have been occurring at a faster pace than before. Some time has passed since the last reset.",
    zh: "最近的随机重置节奏比过去更快。距离上次重置已经过了一段时间。",
  },
  outlookHigh72hPlus: {
    ja: "最近のランダムリセットのペースは、これまでより速めです。前回のリセットからも時間がたっています。",
    en: "Recent random resets have been occurring at a faster pace than before. More time has passed since the last reset.",
    zh: "最近的随机重置节奏比过去更快。距离上次重置已经过了较长时间。",
  },
