...
export const UI_TRANSLATIONS: Record<string, Record<Locale, string>> = {
  ...
  outlookWeakTeaser: {
    ja: "リセットを示唆する投稿が確認されています。リセットの見込みがやや高まっています。",
    en: "A post suggesting a reset has been confirmed. The outlook is somewhat higher.",
    zh: "已确认有暗示重置的帖子，重置的可能性略有上升。",
  },
  outlookUsageAnomaly: {
  ...
  outlookLowCooldownSubminute: {
    ja: "前回のリセットからまだ1分も経過しておらず、過去の発生傾向でもリセット直後は起きにくいため、現在の見込みは低めです。",
    en: "Less than a minute has passed since the last reset, and resets have historically been less common immediately after a reset, so the current outlook is low.",
    zh: "距离上次重置还不到1分钟，根据过去的发生趋势，重置后不久通常较少发生重置，因此目前的可能性较低。",
  },
  outlookLowHistorical: {
    ja: "前回のリセットから{elapsed}が経過していますが、過去の発生傾向では今後24〜48時間のリセット発生率が低いため、現在の見込みは低めです。",
    en: "It has been {elapsed} since the last reset, but historical reset rates over the next 24–48 hours are low, so the current outlook is low.",
    zh: "距离上次重置已过去{elapsed}，但根据过去的发生趋势，未来24至48小时内的重置发生率较低，因此目前的可能性较低。",
  },
  outlookModerateApproaching: {
    ja: "前回のリセットから{elapsed}が経過し、今後24〜48時間が過去にリセットの起きやすかった時間帯に近づいているため、現在の見込みは中程度です。",
    en: "It has been {elapsed} since the last reset, and the next 24–48 hours approach periods when resets have historically been more likely, so the current outlook is moderate.",
    zh: "距离上次重置已过去{elapsed}，未来24至48小时将逐渐接近过去较容易发生重置的时段，因此目前的可能性处于中等水平。",
  },
  outlookHighOverlap: {
    ja: "前回のリセットから{elapsed}が経過し、今後24〜48時間が過去にリセットの起きやすかった時間帯と重なるため、現在の見込みは高めです。",
    en: "It has been {elapsed} since the last reset, and the next 24–48 hours overlap periods when resets have historically been more likely, so the current outlook is high.",
    zh: "距离上次重置已过去{elapsed}，未来24至48小时与过去较容易发生重置的时段重叠，因此目前的可能性较高。",
  },
  outlookVeryHighOverlap: {
    ja: "前回のリセットから{elapsed}が経過し、今後24〜48時間が過去に特にリセットの起きやすかった時間帯と重なるため、現在の見込みは非常に高いです。",
    en: "It has been {elapsed} since the last reset, and the next 24–48 hours overlap periods when resets have historically been especially likely, so the current outlook is very high.",
    zh: "距离上次重置已过去{elapsed}，未来24至48小时与过去特别容易发生重置的时段重叠，因此目前的可能性非常高。",
  },
  outlookGenericLow: {
    ja: "前回のリセットから{elapsed}が経過しており、現在の予測ではリセットの見込みは低めです。",
    en: "It has been {elapsed} since the last reset, and the current forecast puts the outlook for a reset at low.",
    zh: "距离上次重置已过去{elapsed}，根据当前预测，重置的可能性较低。",
  },
  outlookGenericMedium: {
    ja: "前回のリセットから{elapsed}が経過しており、現在の予測ではリセットの見込みは中程度です。",
    en: "It has been {elapsed} since the last reset, and the current forecast puts the outlook for a reset at moderate.",
    zh: "距离上次重置已过去{elapsed}，根据当前预测，重置的可能性处于中等水平。",
  },
  outlookGenericHigh: {
    ja: "前回のリセットから{elapsed}が経過しており、現在の予測ではリセットの見込みは高めです。",
    en: "It has been {elapsed} since the last reset, and the current forecast puts the outlook for a reset at high.",
    zh: "距离上次重置已过去{elapsed}，根据当前预测，重置的可能性较高。",
  },
  outlookGenericVeryHigh: {
    ja: "前回のリセットから{elapsed}が経過しており、現在の予測ではリセットの見込みは非常に高いです。",
    en: "It has been {elapsed} since the last reset, and the current forecast puts the outlook for a reset at very high.",
    zh: "距离上次重置已过去{elapsed}，根据当前预测，重置的可能性非常高。",
  },
  outlookNoElapsedLow: {
