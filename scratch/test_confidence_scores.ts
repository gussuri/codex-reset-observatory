...
const TEST_POSTS = [
  { name: "典型的な匂わせ", text: "recharge... See you back tomorrow for more ChatGPT and Codex fun" },
  { name: "短文の軽い匂わせ", text: "Big week ahead for Codex users. Stay tuned." },
  { name: "かなり曖昧な匂わせ", text: "Cooking something nice for limits. Hope you like it tomorrow." },
  { name: "絵文字多めの匂わせ", text: "⚡🔋 Recharge time coming soon! 🚀" },
  { name: "正式告知", text: "We are resetting rate limits for all Codex subscription tiers at 18:00 UTC today." },
  { name: "リセット完了報告", text: "Outage resolved and we have reset the rate limits for all paid users." },
];
...
async function main() {
  ...
  console.log("=== Testing Confidence Score Distribution Across Tweet Styles ===\n");
