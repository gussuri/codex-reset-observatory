...
export const LOCAL_RESET_HISTORY: Array<WindowEventLike> = [
  {
    ...
    "scope": "全有料プラン",
    "summary": {
      "ja": "品質問題への対応に伴い、CodexおよびChatGPT Workの利用上限が強制リセットされました。",
      "en": "In response to quality issues, usage limits for Codex and ChatGPT Work were forcibly reset.",
      "zh": "为应对质量问题，Codex 和 ChatGPT Work 的使用额度已被强制重置。"
    },
  ...
  },
  {
    ...
    "details": {
      ...
      "noticeType": "なし",
      "note": "前回のリセット後にCodex / Workを初めて使用した時点から、1週間後に定期リセットが行われます。任意リセットを使用した場合も、任意リセット後の初使用から1週間後となるため、この表示時刻とはずれる場合があります。"
    }
  },
  {
    ...
    "kind": "reset_completed",
    "status": "closed",
    "opened_at": "2026-07-31T04:53:19.170Z",
