...
export const LOCAL_OBSERVATION_SIGNALS: Array<LocalObservationSignal> = [
  {
    ...
    status: "resolved",
    resolvedAt: "2026-07-16T13:15:00+09:00",
    expectedAt: "2026-07-16T03:00:00+09:00",
    expectedEndAt: "2026-07-18T12:00:00+09:00",
    expiresAt: "2026-07-16T13:15:00+09:00",
    skipAutoHistoryMerge: true,
    title: "Tibo氏が900万人アクティブユーザー到達に伴う利用制限の追加リセット（または制限緩和）を示唆しました。正確な実施時刻は未告知のため、広めの予想レンジを設定しています。",
  ...
  },
  {
    ...
    type: "probability_boost",
    status: "resolved",
    resolvedAt: "2026-07-18T12:31:00+09:00",
    expiresAt: "2026-07-18T12:31:00+09:00",
    boostValue24h: 0.235,
    boostValue48h: 0.37,
  ...
  },
  {
    ...
    type: "official_notice",
    status: "resolved",
    expectedAt: "2026-07-15T05:45:00+09:00",
    expiresAt: "2026-07-15T09:00:00+09:00",
    resolvedAt: "2026-07-15T05:45:00+09:00",
    skipAutoHistoryMerge: true,
    title:
  ...
  },
  {
    ...
    type: "probability_boost",
    status: "resolved",
    expiresAt: "2026-07-15T06:00:00+09:00",
    boostValue24h: 30,
    boostValue48h: 30,
